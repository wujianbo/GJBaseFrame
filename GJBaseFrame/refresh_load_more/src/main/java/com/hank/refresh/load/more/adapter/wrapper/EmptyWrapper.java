package com.hank.refresh.load.more.adapter.wrapper;
...
import com.hank.refresh.load.more.adapter.utils.WrapperUtils;
...
public class EmptyWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private boolean isEmpty() {
        L.i("-------------->" + mInnerAdapter.getItemCount());
        return (mEmptyView != null || mEmptyLayoutId != 0) && mInnerAdapter.getItemCount() == 2;
    }
